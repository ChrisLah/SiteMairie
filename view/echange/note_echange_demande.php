...
<form class="body" method="post" <?php echo 'action="./index.php?controller=echange&action=notedDemande&idOffre='.$_GET['idOffre'].'&idDemande='.$_GET['idDemande'].'&date='.$_GET['date'].'"'; ?> >
	...
	<label> L'objet qu'on vous a prêté était-il dans une etait satisfaisant ?* </label>
	<div class="row">
		(min) 
		<label for="note01" title="Note&nbsp;: 1 sur 4">1</label>
